...
let blogData = [

    {
        ...
        "contents": [
            ...
            {
                "heading": "Sunsets by the Sea",
                "paragraphs": [
                    "As we transition to coastal landscapes, the sunsets by the sea become a captivating spectacle. The sun, painting the sky in hues of orange, pink, and gold, bids farewell to the day with a breathtaking display of color.",
                    "The rhythmic lullaby of waves accompanies moments of reflection and tranquility. Coastal sunsets are not merely events; they are transformative experiences that invite us to witness the eternal dance between light and water, land and sea."
                ]
            },
            {
                "heading": "Conclusion",
                "paragraphs": [
                    "As we conclude our odyssey through the wonders of nature, we carry with us more than memories. We carry a profound sense of gratitude for the Earth's boundless beauty and a commitment to cherish and protect it.",
                    "Nature, in all its forms, serves as an eternal muse, inspiring us to marvel at the intricate tapestry of life. This blog post is a celebration of that beauty and an acknowledgment of our role in preserving it for generations to come."
                ]
            }
        ]
    },
